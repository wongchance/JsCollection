...
// @updateURL      https://github.com/wongchance/iitcJs/raw/master/gaode-maps.user.js
// @downloadURL    https://github.com/wongchance/iitcJs/raw/master/gaode-maps.user.js
...
function wrapper(plugin_info) {
    ...
    window.plugin.mapGaode.setup = function () {
        ...
        var gaodeSat = L.gaodeLayer('http://wprd0{s}.is.autonavi.com/appmaptile?style=6&x={x}&y={y}&z={z}', {
            type: 'SATELLITE'
        });
        layerChooser.addBaseLayer(gaodeSat, 'Gaode Satellite');

        var gaodeRoad = L.gaodeLayer('http://wprd0{s}.is.autonavi.com/appmaptile?style=7&x={x}&y={y}&z={z}', {
            type: 'ROADS'
        });
        layerChooser.addBaseLayer(gaodeRoad, 'Gaode Roads');

        var gaodeHybrid = L.layerGroup([
            L.gaodeLayer('http://wprd0{s}.is.autonavi.com/appmaptile?style=6&x={x}&y={y}&z={z}', {
                type: 'SATELLITE'
            }),
            L.gaodeLayer('http://wprd0{s}.is.autonavi.com/appmaptile?style=8&x={x}&y={y}&z={z}', {
                type: 'TRANSPARENT',
                opacity: 0.75
            })
        ]);
